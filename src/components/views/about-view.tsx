      ...
      <section className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <FeatureCard
            icon="BookMarked"
            title="Glossary"
            desc="274 curated quant finance definitions across 7 categories — from options Greeks to yield-curve trades. Searchable, expandable, with related-strategy links."
